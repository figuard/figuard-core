...
class NoMatchingAllocationIT extends IntegrationTestBase {
    ...
    @Test
    void authorize_returnsDenied_whenClaimedCategoryMatchesNoAllocation() throws Exception {
        // Budget only has "flight" and "hotel" allocations
    ...
    @Test
    void authorize_succeeds_whenClaimedCategoryMatchesExactAllocation() throws Exception {
        Budget budget = createAllocatedBudget();
