...
class TestGuardedOpenAIFunction:
    ...
    def test_denied_string_format_with_message(self):
        client = _mock_client(_denied("NO_MATCHING_ALLOCATION", "car_rental not in budget"))
        ...
        result = buy(amount=100.0)
        assert result == "FiGuard DENIED: NO_MATCHING_ALLOCATION — car_rental not in budget"
